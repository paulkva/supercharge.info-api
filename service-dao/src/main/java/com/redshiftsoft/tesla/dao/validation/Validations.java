    ...
    public static Collection<Validation> getValidations() {
        ...
        validationMap.add(
                new Validation(SUPERCHARGER, "individual stall and plug counts do not exceed total", "" +
                        ...
                        "OR COALESCE(stall_count, 0) < COALESCE(plugs_tesla_us, 0) + COALESCE(plugs_type2, 0) + COALESCE(plugs_type2_ccs2, 0) + COALESCE(plugs_ccs2, 0) + COALESCE(plugs_gbt_china, 0) + COALESCE(plugs_nacs, 0) + COALESCE(plugs_magicdock, 0) " +
